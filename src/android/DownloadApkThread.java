...
public class DownloadApkThread implements Runnable {
    ...
    public DownloadApkThread(Context mContext, Handler mHandler, TextView mProgress, AlertDialog mDownloadDialog, HashMap<String, String> mHashMap, JSONObject options) {
